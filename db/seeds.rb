...
users = User.create!(
  [
    ...
    {last_name: '昭和', first_name: 'ヒロシ', last_name_kana: 'ショウワ', first_name_kana: 'ヒロシ', employee_id: '0222', affiliation: '総務部', body: 'たまに参加します', delete_status: 'true', email: 'd@example.com', password: 'password', profile_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/user3.jpg"), filename:"user3.jpg")},
    {last_name: '平成', first_name: '一郎', last_name_kana: 'ヘイセイ', first_name_kana: 'イチロー', employee_id: '0001', affiliation: '総務部', body: 'たまに参加します', delete_status: 'false', email: 'c@example.com', password: 'password', profile_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/user3.jpg"), filename:"user3.jpg")}
  ]
)
...
Event.create!(
  [
    ...
    {name: 'ビアガーデン', body: 'テラス席で解放感を味わいましょう！', date: '2022-09-26', start_at: '19:00:00', end_at: '21:00:00', location: '渋谷', cost: '約5、000円', recruit: '4', user_id: users[0].id , genre_id: genres[0].id },
