...
ActiveRecord::Schema.define(version: 2022_09_11_063522) do
  ...
  create_table "notifications", force: :cascade do |t|
    ...
    t.index ["host_user_id"], name: "index_notifications_on_host_user_id"
    t.index ["join_user_id"], name: "index_notifications_on_join_user_id"
  end
